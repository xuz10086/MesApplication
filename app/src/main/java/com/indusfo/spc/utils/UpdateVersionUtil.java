...
import com.indusfo.spc.service.UpdateVersionService;
...
public class UpdateVersionUtil {
    ...
    public static void checkVersion(final Context context, final UpdateListener updateListener) {
        HttpRequest.get(getUrlFromLocal() + NetworkConst.UPDATA_VERSION_REQ, new HttpRequest.RequestCallBackListener() {
